...
(function() {
  'use strict';
  var Card, Cards, fs, sqlite, sqliteSync, variables;
  ...
  Object.defineProperty(Card.prototype, 'isEx', {
    get: function() {
      return this.isSynchro || this.isXyz || this.isFusion || this.isLink;
    }
  });
  ...
  Cards = (function() {
    class Cards {
      ...
      getCardByIDASync(id, callback) {
        ...
        this.generateCardByIDAsync(id, callback);
        return 0;
      }
      ...
      generateCardByID(id) {
        var card, row, stmt;
        stmt = this.dbSync.prepare(Cards.readDataSQL);
        row = stmt.get(id);
        if (row) {
          card = new Card(row);
    ...
    Cards.localePath = variables.localePath;
